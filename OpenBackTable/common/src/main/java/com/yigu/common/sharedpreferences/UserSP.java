package com.yigu.common.sharedpreferences;
...
public class UserSP extends AbstractSP {
    ...
    private final static String KEY_SP_USER = "openback.user";
    private final static String KEY_SP_USER_GUIDE = "openback_user_guide";
    private final static String KEY_SP_Resources = "openback.resources";
    private final static String KEY_SP_Alias = "openback_user_Alias";
