package com.yigu.openbacktable.activity.pay;
        ...
        payWayLayout.setPayWayListener(new PayWayLayout.PayWayListener() {
            ...
            public void preorder() {
                if(TextUtils.isEmpty(payWayLayout.getAddr())){
                    ...
                    showLoading();
                    OrderApi.preorderay(PaymentActivity.this, userSP.getUserBean().getUSER_ID(), SHOP, allPrice+"", sales,payWayLayout.getAddr(), new RequestCallback() {
                        @Override
