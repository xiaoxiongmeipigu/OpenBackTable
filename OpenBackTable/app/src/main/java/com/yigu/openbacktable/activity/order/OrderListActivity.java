...
import com.yigu.openbacktable.adapter.order.OrderListAadpter;
...
//    TimePickerView pvTime;
    ...
    private void load() {
        DebugLog.i("dateStr=>"+dateStr);
        OrderApi.getFoodmenu(this, mapiOrderResult.getID(), dateStr, type, style, pageIndex + "", pageSize + "", new RequestPageCallback<List<MapiOrderResult>>() {
            @Override
    ...
    @OnClick({R.id.back,R.id.purcase, R.id.deel, R.id.ll_time, R.id.ll_types})
