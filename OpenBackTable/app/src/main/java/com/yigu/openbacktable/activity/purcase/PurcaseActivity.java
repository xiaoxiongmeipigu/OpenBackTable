package com.yigu.openbacktable.activity.purcase;
...
import com.yigu.openbacktable.activity.order.OrderCompleteActivity;
import com.yigu.openbacktable.adapter.purcase.PurcaseAdapter;
import com.yigu.openbacktable.base.BaseActivity;
import com.yigu.openbacktable.util.AnimationUtil;
import com.yigu.openbacktable.view.PayWayLayout;
        ...
        payWayLayout.setPayWayListener(new PayWayLayout.PayWayListener() {
            ...
            public void preorder() {
                if(TextUtils.isEmpty(payWayLayout.getAddr())){
                    ...
                    showLoading();
                    OrderApi.preorderay(PurcaseActivity.this, userSP.getUserBean().getUSER_ID(), SHOP, allPrice+"", sales,payWayLayout.getAddr(), new RequestCallback() {
                        @Override
